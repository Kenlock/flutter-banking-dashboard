...
_generateExpenses() {
  List<Expense> expenses = [
    Expense(name: 'Withdrawal', cost: rand.nextDouble() * 90),
...
List<Category> categories = [
  Category(name: 'Withdrawal', maxAmount: 450, expenses: _generateExpenses()),
  Category(name: 'Mobile Banking', maxAmount: 500, expenses: _generateExpenses()),
